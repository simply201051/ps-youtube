(function(angular, document, window) {
	...
	psYoutubeRun.$inject = ['$rootScope', 'youtubePlayer'];

	function psYoutubeRun($rootScope, youtubePlayer) {
		loadYoutubeApi();
		appendStyle();
